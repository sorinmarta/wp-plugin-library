...
if( ! class_exists( 'WPPL_Form' ) ){
	class WPPL_Form{
		...
		private function render_select( array $input ): void {
			...
			echo '<' . $input['element'] . ' name="' . $input['name'] . '" id="' . $input['id'] . 'class="wppl-input ' . ( ( $input['class'] ?? '' ) ) . '">';
		...
		private function render_label( array $input ): void {
			...
			echo '<label id="'. $input['id'] . '" class="wppl-input wppl-label ' . ( ( $input['class'] ?? '' ) ) . '" for="' . $input['for'] . '">';
			echo $input['content'];
			echo '</label>';
		...
		private function render_text( array $input ): void {
			...
			echo '<'. $input['element'] .' id="'. $input['id'] . '" class="wppl-heading wppl-form-heading ' . ( ( $input['class'] ?? '' ) ) . '">';
			echo $input['content'];
			echo '</'. $input['element'] .'>';
